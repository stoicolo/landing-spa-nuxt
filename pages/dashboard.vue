...
const navigation = [
  ...
  { name: "Reportes", href: "#", icon: CursorArrowRippleIcon, current: false },
];
...
<template>
  <div>
    ...
    >
      <!-- Sidebar component, swap this element with another sidebar if you like -->
      <div
        class="flex grow flex-col gap-y-5 overflow-y-auto bg-fountain-blue-950 px-6 pb-4"
      >
        <div class="flex h-28 shrink-0 items-center">
          <img
            class="h-20 w-auto"
            src="/img/footprint_initiative_white.png"
            alt="Footprint initiative logo"
          />
        </div>
        <nav class="flex flex-1 flex-col">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
