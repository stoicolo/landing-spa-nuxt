  ...
  <div class="relative z-10 mt-32 bg-gray-900 pb-20 sm:mt-56 sm:pb-24 xl:pb-0">
    ...
    >
      <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
        <div
          class="aspect-[2/1] xl:aspect-auto relative h-full md:-mx-8 xl:mx-0 mx-16 lg:mx-0"
        >
          <img
      ...
      >
        <figure class="relative isolate pt-6 sm:pt-12">
          ...
          >
            <p>
              En ésta Plataforma buscamos visibilizar todos aquellos esfuerzos
              de empresas que buscan la circularidad, y de esta forma
              dignificarlas y acompañarlas en este proceso tan apasionante de
              mejorar sus huellas ambientales, sociales y económicas.
            </p>
          </blockquote>
          <figcaption class="mt-8 text-base">
            <div class="font-semibold text-white">MSc. Ing Melissa Díaz</div>
            <div class="mt-1 text-gray-400">
              Fundadora y Co-Directora de la Fundación The Footprint Initiative
            </div>
          </figcaption>
        </figure>
      </div>
