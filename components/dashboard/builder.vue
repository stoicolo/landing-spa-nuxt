        ...
        <template v-for="(section, index) in sortedSections" :key="section.id">
            <div class="section-wrapper">
                <component v-if="section.widget && section.widget.element"
                    :is="getComponent(section.widget.name, section.widget.element)" v-bind="section.widget.element" :id="section.id"/>
                <div class="section-actions">
                    ...
                    <button @click="templateStore.addSection(section.position + 1)">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
export default {
    ...
    setup() {
        ...
        return { sortedSections, getComponent, templateStore };
    }
};
</script>